...
archived_url: https://web.archive.org/web/https://epoch.ai/gradient-updates/how-much-energy-does-chatgpt-use
title: How much energy does ChatGPT use?
publisher: Epoch AI
published_date: '2025-01-01'
accessed_date: '2026-04-29'
kind: blog
summary: Analysis estimating that a typical GPT-4o query consumes roughly 0.3 watt-hours,
  challenging previous estimates of 3 watt-hours based on updated hardware and usage
  assumptions.
key_quotes:
