...
archived_url: http://web.archive.org/web/20260428101130/https://brave.com/leo/
title: Brave Leo AI
publisher: Brave
accessed_date: '2026-04-30'
kind: documentation
summary: Overview of Brave Leo, a privacy-focused AI assistant integrated into the
  Brave browser, featuring model options, BYOM capabilities, and local chat history.
key_quotes:
