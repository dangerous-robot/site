...
Reference documents describing how the system works today. See [AGENTS.md](/AGENTS.md) for rules on maintaining these docs.

| File | Describes |
|------|-----------|
| [site.md](site.md) | Astro stack, page routing, layout, build output, deployment |
| [content-model.md](content-model.md) | Content types (entities, claims, sources), Zod schemas, relationships, directory conventions |
